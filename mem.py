...
"""La función "fillMem" se usa para agregar nuevos procesos a la memoria,
se verifica que haya espacio libre y en caso de no tener 
espacio para agregar más elementos se llama a la función "compact".
...
"""La función "eraseMem" se usa para eliminar elementos de la memoria,
...
"""La función "compact" sirve para agregar procesos a la memoria, 
...
elementos, muestra el mapa de memoria."""

def compact(proc, tam):
	global memoria

	existe_espacio = '-' in memoria[0:30]
	if existe_espacio:
...
puede escoger, además de verificar si los procesos que se quieren agregar ya existen."""
